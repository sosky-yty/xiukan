...
import com.example.sosky.xiukan.adapter.ActressPaletteAdapter;
import com.example.sosky.xiukan.adapter.MovieHeaderAdapter;
import com.example.sosky.xiukan.adapter.ScreenshotAdapter;
...
import com.example.sosky.xiukan.network.PSVS;
...
import com.example.sosky.xiukan.util.SimpleVideoPlayer;
...
public class MovieActivity extends SecureActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<ResponseBody> call = XiuKan.SERVICE.get(this.movie.getLink());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        {
            if (XiuKan.CONFIGURATIONS.getStarredMovies().contains(movie)) {
        ...
        mStarButton.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (XiuKan.CONFIGURATIONS.getStarredMovies().contains(movie)) {
                    XiuKan.CONFIGURATIONS.getStarredMovies().remove(movie);
                    ...
                    List<Movie> movies = XiuKan.CONFIGURATIONS.getStarredMovies();
        ...
        mShareButton.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                try {
                    ...
                    Uri uri = FileProvider.getUriForFile(getApplicationContext(), "io.github.XiuKan.fileprovider", cache);
    ...
    public void onPlay() {
        ...
        if (video != null) {
            JZVideoPlayerStandard.startFullscreen(
                    ...
                    String.format("http://api.rekonquer.com/psvs/mp4.php?vid=%s&ts=%s&sign=%s", video.vid, ts, XiuKan.b(video.vid, ts)),
                    movie.title
            );
            return;
        }
    ...
    public void onPlay() {
        ...
        if (video != null) {
            ...
            Request request = new Request.Builder()
                    ...
                    .build();
            XiuKan.HTTP_CLIENT.newCall(request).enqueue(new okhttp3.Callback() {
                @Override
