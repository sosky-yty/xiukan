...
import com.example.sosky.xiukan.fragement.favouite.FavouriteTabsFragment;
import com.example.sosky.xiukan.fragement.genre.GenreTabsFragment;
import com.example.sosky.xiukan.network.BasicService;
import com.example.sosky.xiukan.util.ExoPlayerImpl;
...
public class XiuKan extends Application {
    ...
    public static DataSource getDataSource() {
        return XiuKan.CONFIGURATIONS.getDataSource();
    }

    public static void recreateService() {
        SERVICE = new Retrofit.Builder()
                .baseUrl(XiuKan.getDataSource().getLink())
    ...
    public static File getStorageDir() {
        File dir = new File(Environment.getExternalStorageDirectory(), "XiuKan/");
        dir.mkdirs();
        return dir;
    }
